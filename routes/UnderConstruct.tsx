...
const Page : NextPage = () => {
    ...
    return (<>
        <Head>
            ...
            <meta name="description" content="Maaf, halaman ini sedang dalam pembangunan atau sedang dalam perawatan." />
        </Head>
        <GenericSection classes={[sheet.construction]} theme='primary' mild={true}>
            ...
            <article>
                ...
                <p className='lead'>
                    Maaf, halaman ini sedang dalam pembangunan atau sedang dalam perawatan.
                </p>
                <p className='lead'>
                    Silakan datang ke sini lain waktu 😋
                </p>
            </article>
        </GenericSection>
    </>);
